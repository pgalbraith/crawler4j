...
public class Counters {
    ...
    public Counters(BerkeleyJeFrontier frontier, CrawlConfig config) {
        ...
        statisticsDB = frontier.env.openDatabase(null, DATABASE_NAME, dbConfig);

        OperationStatus result;
        DatabaseEntry key = new DatabaseEntry();
        DatabaseEntry value = new DatabaseEntry();
        Cursor cursor = statisticsDB.openCursor(frontier.getTransaction(), null);
        ...
        synchronized (mutex) {
            try {
                ...
                if (statisticsDB != null) {
                    statisticsDB.put(frontier.getTransaction(), new DatabaseEntry(name.getBytes()),
